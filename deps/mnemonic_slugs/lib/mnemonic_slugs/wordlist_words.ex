defmodule MnemonicSlugs.Wordlist.Words do
  ...
  Returns the list of mnemonic words.
      ...
      iex> MnemonicSlugs.Wordlist.Words.list
      ["abraham", "absent", "absorb", "absurd", "academy", "accent", "acid",
       "acrobat", "action", "active", "actor", "adam", "address", "adios",
       "admiral", "adrian", "africa", "agatha", "agenda", "agent", "airline",
       "airport", "alabama", "aladdin", "alamo", "alarm", "alaska", "albert",
       "albino", "album", "alcohol", "alert", "alex", "alfonso", "alfred",
       "algebra", "alias", "alibi", "alice", "alien", "almanac", "almond",
       "aloha", "alpha", "alpine", "amadeus", "amanda", "amazon", "amber",
       "ambient", ...]
  """
  def list do
    ~W(
...
year     yellow   yes      yoga     yogurt   young    yoyo     zebra    zero     zigzag   zipper   zodiac
zoom)
  end
end
