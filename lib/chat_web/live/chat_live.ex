defmodule ChatWeb.ChatLive do
  ...
  def render(assigns) do
    ...
    <div class="mt-5 mb-5 text-base">Share this chat <em><%= @uri %></em></div>
    <div class="mt-5 mb-5 text-base"><button class="btn-link" phx-click="refresh">Create</button> new random chat</div>
