(() => {
  ...
  var MarkdownElement = class extends HTMLElement {
    constructor() {
      super();
    ...
    async render() {
      if (!this.isConnected || this._mdContent === void 0) {
        return;
      }
      if (!marked) {
    ...
    static async sanitize(html) {
      ...
      DOMPurify = await DOMPurify;
      return DOMPurify.sanitize(html);
    }
  };
  var MarkdownSpan = class extends MarkdownElement {
    constructor() {
      super();
    }
    _parse() {
  ...
  __publicField(MarkdownSpan, "renderer", {
    codespan(code) {
  ...
  var MarkdownBlock = class extends MarkdownElement {
    constructor() {
      super();
    }
    get src() {
    ...
    get hlinks() {
      var _a;
      return (_a = this._hlinks) != null ? _a : null;
    }
    set hlinks(value) {
  ...
  __publicField(MarkdownBlock, "renderer", Object.assign({
